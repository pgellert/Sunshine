...
public class Utility {
    ...
    int getLocationStatus(Context context){
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        return prefs.getInt(context.getString(R.string.pref_location_status),
    ...
    public static String getArtUrlForWeatherCondition(Context context, int weatherId) {
        ...
        String formatString = sp.getString(context.getString(R.string.pref_art_pack_key)
                ,context.getString(R.string.pref_art_pack_default));


        if (weatherId >= 200 && weatherId <= 232) {
            return String.format(Locale.US,formatString, "storm");
        } else if (weatherId >= 300 && weatherId <= 321) {
            return String.format(Locale.US,formatString, "light_rain");
        } else if (weatherId >= 500 && weatherId <= 504) {
            return String.format(Locale.US,formatString, "rain");
        } else if (weatherId == 511) {
            return String.format(Locale.US,formatString, "snow");
        } else if (weatherId >= 520 && weatherId <= 531) {
            return String.format(Locale.US,formatString, "rain");
        } else if (weatherId >= 600 && weatherId <= 622) {
            return String.format(Locale.US,formatString, "snow");
        } else if (weatherId >= 701 && weatherId <= 761) {
            return String.format(Locale.US,formatString, "fog");
        } else if (weatherId == 761 || weatherId == 781) {
            return String.format(Locale.US,formatString, "storm");
        } else if (weatherId == 800) {
            return String.format(Locale.US,formatString, "clear");
        } else if (weatherId == 801) {
            return String.format(Locale.US,formatString, "light_clouds");
        } else if (weatherId >= 802 && weatherId <= 804) {
            return String.format(Locale.US,formatString, "clouds");
        }
        return null;
    }

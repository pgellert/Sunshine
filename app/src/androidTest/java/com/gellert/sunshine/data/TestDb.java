 ...
 */
package com.gellert.sunshine.data;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    public long testLocationTable() {
        ...
        assertTrue("Error: no records returned from the location query", c.moveToFirst());

        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: current record is not valid.",c,contentValues);

        assertFalse("Error: more than one records returned from the location query", c.moveToNext());
    ...
    public void testWeatherTable() {
        ...
        TestUtilities.validateCurrentRecord("Error : returned cursor not valid",c,contentValues);
